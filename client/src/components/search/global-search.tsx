...
const staticPages = [
  ...
  { title: "مخطط الحوض", url: "/fish-finder-advanced", keywords: ["planner", "مخطط", "حوض", "تخطيط"] },
  { title: "تحديد الأسماك", url: "/fish-identifier", keywords: ["identifier", "تحديد", "تعرف", "صورة"] },
...
// Popular/Quick Links
const popularItems = [
  { title: "فلاتر المياه", url: "/products", category: "فلاتر" },
  { title: "سخانات الحوض", url: "/products", category: "سخانات" },
  { title: "الإضاءة LED", url: "/products", category: "إضاءة" },
  { title: "النباتات المائية", url: "/products", category: "نباتات" },
];
