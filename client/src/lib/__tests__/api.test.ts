...
import { fetchProducts, fetchProduct, fetchProductBySlug } from '../api';
...
describe('API Client', () => {
  ...
  describe('fetchProduct', () => {
    it('should fetch single product by id', async () => {
      ...
      expect(global.fetch).toHaveBeenCalledWith('/api/products/prod-123', {
        credentials: 'include',
        headers: { 'Content-Type': 'application/json' },
      });
  ...
  describe('fetchProductBySlug', () => {
    it('should fetch product by slug', async () => {
      ...
      expect(global.fetch).toHaveBeenCalledWith(
        '/api/products/slug/test-product',
        {
          credentials: 'include',
          headers: { 'Content-Type': 'application/json' },
        }
    ...
    it('should handle slugs with hyphens', async () => {
      ...
      expect(global.fetch).toHaveBeenCalledWith(
        '/api/products/slug/my-awesome-product',
        expect.any(Object)
      );
    });
