                ...
                <Card className="border-2">
                  <CardContent className="p-6 md:p-8 space-y-8">
                    ...
                    <div className="bg-primary/5 border border-primary/20 rounded-xl p-4 flex gap-3">
                      ...
                      <div>
                        <div className="font-bold text-foreground mb-1">نصيحة الخبراء</div>
                ...
                <Card className="border-2">
                  <CardContent className="p-6 md:p-8 space-y-8">
                    ...
                    <div className="bg-amber-500/10 border border-amber-500/20 rounded-xl p-4 flex gap-3">
                      ...
                      <div>
                        <div className="font-bold text-foreground mb-1">تحذير مهم</div>
                        <p className="text-sm text-muted-foreground">
                  ...
                  <CardContent className="p-6 md:p-8 space-y-8">
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="bg-muted/30 rounded-xl p-4">
                        <div className="font-bold text-sm mb-2">التوصية:</div>
                ...
                <Card className="border-2">
                  <CardContent className="p-6 md:p-8 space-y-8">
                    ...
                    <div className="bg-primary/5 border border-primary/20 rounded-xl p-4 flex gap-3">
                      ...
                      <div>
                        <div className="font-bold text-foreground mb-1">نصائح التصميم</div>
                ...
                <Card className="border-2">
                  <CardContent className="p-6 md:p-8 space-y-8">
                    ...
                    <div className="bg-red-500/10 border border-red-500/20 rounded-xl p-4 flex gap-3">
                      ...
                      <div>
                        <div className="font-bold text-foreground mb-1">تحذير حيوي</div>
                        <p className="text-sm text-muted-foreground">
                ...
                <Card className="border-2">
                  <CardContent className="p-6 md:p-8 space-y-8">
                    ...
                    <div className="bg-gradient-to-br from-blue-500/10 to-green-500/10 border border-primary/20 rounded-xl p-6">
                      ...
                      <div className="space-y-3 text-sm">
                        <div className="flex items-start gap-3">
                          ...
                          <div>
                            <div className="font-bold text-foreground">الأمونيا (NH₃)</div>
                            <div className="text-muted-foreground">سامة جداً - من فضلات الأسماك والطعام المتحلل</div>
                          </div>
                        </div>
                        ...
                        <div className="flex items-start gap-3">
                          ...
                          <div>
                            <div className="font-bold text-foreground">النيتريت (NO₂)</div>
                            <div className="text-muted-foreground">سام أيضاً - تحوله بكتيريا Nitrosomonas</div>
                          </div>
                        </div>
                        ...
                        <div className="flex items-start gap-3">
                          ...
                          <div>
                            <div className="font-bold text-foreground">النترات (NO₃)</div>
                            <div className="text-muted-foreground">أقل سمية - تزيله النباتات وتغييرات الماء</div>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="bg-red-500/10 border-2 border-red-500/30 rounded-xl p-4 flex gap-3">
                      ...
                      <div>
                        <div className="font-bold text-foreground mb-2 text-lg">قاعدة ذهبية</div>
                ...
                <Card className="border-2">
                  <CardContent className="p-6 md:p-8 space-y-8">
                    ...
                    <div className="bg-amber-500/10 border border-amber-500/20 rounded-xl p-4 flex gap-3">
                      <AlertCircle className="h-5 w-5 text-amber-500 flex-shrink-0 mt-1" />
                      <div>
                        <div className="font-bold text-foreground mb-1">التوافق مهم جداً!</div>
                        <ul className="text-sm text-muted-foreground space-y-1 list-disc list-inside">
                      ...
                      <div className="relative z-10">
                        <div className="flex items-start justify-between gap-4 mb-4">
                          <div className="flex items-start gap-3">
                            ...
                            <div>
                              <h3 className="text-xl font-bold text-foreground">Journey Bundle - حزمة الرحلة</h3>
                              <p className="text-sm text-muted-foreground mt-1">احصل على حزمة كاملة مع خصم 10%</p>
                            </div>
                          </div>
