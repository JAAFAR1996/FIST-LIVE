          ...
          <div className="container mx-auto px-4">
            <div className="grid md:grid-cols-2 gap-12">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start gap-4">
                  <div className="bg-purple-100 dark:bg-purple-900/50 p-3 rounded-full text-purple-600">
                    <Leaf className="w-6 h-6" />
                  </div>
                  <div>
                    <h3 className="text-2xl font-bold mb-2">4. اختيار الأسماك المحلية</h3>
                    <p className="text-muted-foreground leading-relaxed">
                      اختر أسماكاً متأقلمة مع المناخ المحلي لتقليل الحاجة لأجهزة التدفئة أو التبريد المستهلكة للطاقة.
                    </p>
                  </div>
                </div>

                <div className="flex items-start gap-4">
                  <div className="bg-cyan-100 dark:bg-cyan-900/50 p-3 rounded-full text-cyan-600">
                    <Droplets className="w-6 h-6" />
                  </div>
                  <div>
                    <h3 className="text-2xl font-bold mb-2">5. الدورة الطبيعية للنيتروجين</h3>
                    <p className="text-muted-foreground leading-relaxed">
                      افهم دورة النيتروجين واستخدمها لتقليل الحاجة لتنظيف الحوض بشكل متكرر. البكتيريا النافعة ستقوم بالعمل الشاق!
                    </p>
                  </div>
                </div>
              </div>
